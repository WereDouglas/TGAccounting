    ...
    public partial class AddTax : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(existingID))
            {
                ...
                {
                    Taxes j = new Taxes(existingID, Convert.ToDateTime(dateTxt.Text).Year.ToString(), weekLbl.Text, startLbl.Text, endLbl.Text, itemTxt.Text, Convert.ToDouble(amountTxt.Text));
            ...
            Taxes i = new Taxes(ID, Convert.ToDateTime(dateTxt.Text).Year.ToString(), weekLbl.Text, startLbl.Text, endLbl.Text, itemTxt.Text, Convert.ToDouble(amountTxt.Text));
            DBConnect.Insert(i);
